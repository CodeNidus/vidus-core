import userTokenHelper from './userTokenHelper.js';
import globalHelper from './globalHelper.js';
import canvasTextAction from './canvasTextAction.js';
import faceApiAction from './faceApiAction.js';
import uiHelper from './uiHelper.js';
import actionHelper from './actionHelper.js';

export default (axios, configs, self) => {
    ...
    Helper.initialHelpers = (axios, configs, self) => {
        ...
        Helper.core = self;
        Helper.token = userTokenHelper(Helper);

        return {
            userToken: Helper.token,
            global: globalHelper(Helper),
            canvasTextAction: canvasTextAction(Helper),
            faceApiAction: faceApiAction(Helper),
            ui: uiHelper(Helper),
            authenticatedRequest: Helper.authenticatedRequest,
            action: actionHelper(Helper),
        };
    };
